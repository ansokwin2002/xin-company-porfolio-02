        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
              How we do it in <span className="text-blue-600">3 Easy Steps</span>
            </h2>
            ...
            <div className="lg:col-span-5 flex flex-col gap-4">
              {steps.map((step) => {
                ...
                return (
                  <button
                    key={step.id}
                    // Added onMouseEnter to trigger selection on hover
                  ...
                  >
                    <div className="flex items-center justify-between relative z-10">
                      <div className="flex items-center gap-4">
                        {/* Icon now keeps original color but changes opacity until hovered/active */}
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300
                          ${step.styles.iconBg} ${isActive ? 'text-white shadow-lg opacity-100 scale-110' : 'text-white opacity-60 group-hover:opacity-100 group-hover:scale-105'}
                        `}>
                ...
                <div key={activeStep} className="relative z-10 animate-fadeInUp">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex gap-1">
                      {steps.map((s) => (
                        <div key={s.id} className={`h-1.5 w-6 rounded-full transition-all duration-300 ${s.id === activeStep ? s.styles.iconBg : 'bg-gray-100'}`} />
                      ))}
                    </div>
          ...
          <div className="relative overflow-hidden bg-[#2a2a2a] rounded-[40px] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 shadow-2xl border border-white/5">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-4xl md:text-6xl font-bold text-white leading-tight mb-6 tracking-tight">
                Let's make people <span className="text-blue-500">fall in love</span> <br className="hidden lg:block" /> with your app
              </h2>
              <p className="text-gray-300 text-lg md:text-xl mb-10 max-w-2xl leading-relaxed">
                Tell us about your app idea, and our team will work with you to create something amazing that your users will absolutely love.
              </p>
              <button className="group relative inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 px-10 rounded-2xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg">
