  ...
  return (
    <section id="contact" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Response Time */}
        <div className="text-center mt-12 bg-white p-6 rounded-xl border border-gray-200">
          <p className="text-gray-600">
            <span className="font-semibold text-gray-900">Quick Response Guaranteed:</span> 
